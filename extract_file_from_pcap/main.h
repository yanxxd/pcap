...
#define AUTHOR      "Jesse Kornblum, Kris Kendall, and Nick Mikus, NKAMG Team"
...
#define LOG_FILE_NAME           "getfiles.log"
...
enum INPUT_FILE_TYPE{INPUT_FILE_TYPE_PCAP};
...
typedef struct f_state 
{
  ...
  enum INPUT_FILE_TYPE input_file_type;
} f_state;
...
int write_to_disk(f_state *s,s_spec * needle,u_int64_t len,unsigned char* buf,  u_int64_t t_offset, void *conn);
...
extern "C" {
#endif
unsigned char* extract_file(f_state *s,  u_int64_t c_offset,unsigned char *foundat,  u_int64_t buflen, s_spec * needle, u_int64_t f_offset, void *conn);
#ifdef __cplusplus
}
#endif
